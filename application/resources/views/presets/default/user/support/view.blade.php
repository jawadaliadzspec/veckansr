        ...
        <div class="col-md-12">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                ...
                @if ($myTicket->status != 3 && $myTicket->user)
                    <button class="btn btn--base btn--sm btn-danger close-button mb-2 confirmationBtn " type="button"
            ...
            @if ($myTicket->status != 4)
                <form method="post" action="{{ route('ticket.reply', $myTicket->id) }}"
                    ...
                    <button type="submit" class="btn btn--base btn--sm mt-2"> <i class="fa fa-reply"></i>
                        @lang('Reply')</button>
                </form>
            @endif
