                ...
                <div class="section-content">
                    <div class="title-wrap">
                        <h2 class="section-title mb-2 wow animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                            <?php echo e(__($featureCoupon->data_values->heading)); ?>

                        </h2>
                        <a href="<?php echo e(route('feature.coupons')); ?>"><?php echo app('translator')->get('View More'); ?></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row gy-4 justify-content-center">
            <?php $__currentLoopData = $featuredCouponsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body justify-content-center align-items-center">
                            ...
                            <div class="copy-code-input">
                                ...
                                <a href="" class="btn btn--base copy-btn copytext" id="copyBoard-feature" target="_blank"><i
...
<?php $__env->startPush('script'); ?>
    <script>
        (function($) {
            ...
            $('#copyBoard-feature').on('click', function() {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/veckansr/application/resources/views/presets/default/sections/feature_coupon.blade.php ENDPATH**/ ?>