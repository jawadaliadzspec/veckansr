                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="coupon-card wow animate__animated animate__fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div class="card-thumb">
                                <img src="<?php echo e(getImage(getFilePath('store') . '/' . @$item->store->image)); ?>" height="90px" width="90px" alt="<?php echo app('translator')->get('Store Image'); ?>">
                            </div>
...
<?php echo $__env->make($activeTemplate.'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/veckansr/application/resources/views/presets/default/coupons.blade.php ENDPATH**/ ?>