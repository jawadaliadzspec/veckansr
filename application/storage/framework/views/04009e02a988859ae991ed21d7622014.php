...
<section class="exclusive-section py-115">
    <div class="container">
                ...
                <div class="section-content">
                    <div class="title-wrap">
                        <h2 class="section-title mb-2 wow animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                            <?php echo e(__($exclusiveCoupon->data_values->heading)); ?>

                        </h2>
                        <a href="<?php echo e(route('exclusive.coupons')); ?>"><?php echo app('translator')->get('View More'); ?></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row gy-4 justify-content-center">
            ...
            <?php $__currentLoopData = $exlusivesCouponsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-3 col-md-6">
                    <div class="coupon-card wow animate__animated animate__fadeInUp" data-wow-delay="0.5s">
                        <div class="card-ribbon-wrap">
                            <button class="fav-cta addToWishList1" data-id="<?php echo e($item->id); ?>">
                        ...
                        <div class="card-thumb">
                            <img src="<?php echo e(getImage(getFilePath('store') . '/' . @$item->store->image)); ?>" height="90px" width="90px"
                        ...
                        <div class="card-content-wrap">
                            ...
                            <?php if($item->expire_date): ?>
                                <p class="card-action"><?php echo isExpired($item->id); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body justify-content-center align-items-center">
                            ...
                            <p class="title"></p>
                            <p class="storeTitle"><?php echo app('translator')->get('Copy and paste this code at'); ?> <a href="" class="text--base storeName"
                                    target="_blank"></a></p>
...
<?php /**PATH /var/www/html/veckansr/application/resources/views/presets/default/sections/exclusive_coupons.blade.php ENDPATH**/ ?>