                ...
                <div class="card p-3 rounded-3">
                    <div class="row g-0">
                        ...
                        <div class="col-sm-4 col-6 col-xl-6 col-xxl-4">
                            <div class="dashboard-widget">
                                <div class="dashboard-widget__icon">
                                    <i class="dashboard-card-icon las la-percentage"></i>
                                </div>
                                <div class="dashboard-widget__content">
                                    <a title="<?php echo app('translator')->get('View all'); ?>" class="dashboard-widget-link"
                                        href="<?php echo e(route('admin.coupon.index')); ?>"></a>
                                    <h5><?php echo e($widget['totalCoupon']); ?></h5>
                                    <span><?php echo app('translator')->get('Total Coupons'); ?></span>
                                </div>
                        ...
                        <div class="col-sm-4 col-6 col-xl-6 col-xxl-4">
                            <div class="dashboard-widget">
                                ...
                                <div class="dashboard-widget__content">
                                    <a title="<?php echo app('translator')->get('View all'); ?>" class="dashboard-widget-link"
                                        href="<?php echo e(route('admin.category.index')); ?>"></a>
                                    <h5><?php echo e($widget['totalCategory']); ?></h5>
                                    <span><?php echo app('translator')->get('Total Categories'); ?></span>
                                </div>
                        ...
                        <div class="col-sm-4 col-6 col-xl-6 col-xxl-4">
                            <div class="dashboard-widget">
                                <div class="dashboard-widget__icon">
                                    <i class="dashboard-card-icon las la-store"></i>
                                </div>
                                <div class="dashboard-widget__content">
                                    <a title="<?php echo app('translator')->get('View all'); ?>" class="dashboard-widget-link"
                                        href="<?php echo e(route('admin.store.index')); ?>"></a>
                                    <h5><?php echo e($widget['totalStore']); ?></h5>
                                    <span><?php echo app('translator')->get('Total Stores'); ?></span>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/veckansr/application/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>