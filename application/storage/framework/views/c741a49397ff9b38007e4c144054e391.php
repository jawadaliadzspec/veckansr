    ...
    <div class="container">
        <div class="row gy-4 justify-content-center">
            ...
            <div class="col-lg-9 main-content">
                <div class="row gy-4">
                    <?php $__empty_1 = true; $__currentLoopData = $featureCoupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="row py-4">
                    <div class="col-lg-12 justify-content-center d-flex">
                        ...
                        <?php if($featureCoupons->hasPages()): ?>
                        <div class="py-4">
                            <?php echo e(paginateLinks($featureCoupons)); ?>
...
<script>
    (function ($) {
        ...
        function getFilteredData(stores, categories,searchValue){
            $.ajax({
                type: "get",
                url: "<?php echo e(route('feature.coupon.filtered')); ?>",
                data:{
...
<?php echo $__env->make($activeTemplate.'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\adzspec\veckansr\application\resources\views/presets/default/feature_coupons.blade.php ENDPATH**/ ?>