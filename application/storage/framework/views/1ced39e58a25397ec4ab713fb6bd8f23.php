                    ...
                    <table class="table table--light style--two custom-data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo e(getImage(getFilePath('adImage') . '/' . $item->image)); ?>" alt="<?php echo app('translator')->get('adImage'); ?>" style="width: 50px"></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/veckansr/application/resources/views/admin/ad/index.blade.php ENDPATH**/ ?>