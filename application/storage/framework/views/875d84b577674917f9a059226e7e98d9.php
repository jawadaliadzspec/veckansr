    ...
    <div class="container">
        <div class="row gy-4 justify-content-center">
            ...
            <div class="col-lg-9 main-content">
                <div class="row gy-4">
                    <?php $__empty_1 = true; $__currentLoopData = $exclusiveCoupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-lg-4 col-md-6">
                        <div class="coupon-card wow animate__animated animate__fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div class="card-thumb">
                                <img src="<?php echo e(getImage(getFilePath('store') . '/' . @$item->store->image)); ?>" height="90px" width="90px" height="90px" width="90px" alt="<?php echo app('translator')->get('Store Image'); ?>">
                            </div>
                ...
                <div class="row py-4">
                    <div class="col-lg-12 justify-content-center d-flex">
                        ...
                        <?php if($exclusiveCoupons->hasPages()): ?>
                        <div class="py-4">
                            <?php echo e(paginateLinks($exclusiveCoupons)); ?>
...
<script>
    (function ($) {
        ...
        function getFilteredData(stores, categories,searchValue){
            $.ajax({
                type: "get",
                url: "<?php echo e(route('exclusive.coupon.filtered')); ?>",
                data:{
...
<?php echo $__env->make($activeTemplate.'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/veckansr/application/resources/views/presets/default/exclusive_coupons.blade.php ENDPATH**/ ?>